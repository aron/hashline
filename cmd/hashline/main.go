// hashline — line-addressable file reader and editor for the pi agent.
//
// Subcommands:
//
...
AGENT QUICK-START
  1. Read a file:       hashline read /workspace/foo.go
  2. Edit it:           printf '{"edits":[...]}' | hashline edit /workspace/foo.go
  3. Re-read to verify: hashline read /workspace/foo.go
  4. Search:            rg --json 'pattern' /workspace | hashline ripgrep
